...
({
  ...
  classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/VhnnhMdyN/model.json', modelLoaded);
  ...
  function gotResult(error , results) 
  {
    ...
    if(results[0].label == "Stop")
    {
      ...
      document.getElementById("update_emoji").innerHTML = "&#9995; Please Stop";
